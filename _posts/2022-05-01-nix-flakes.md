...
## An input from github ; here I'm using my own forked version of nixpkgs
```
inputs = {
...
## An input from github ; using a sub folder of the repo
```
inputs = {
...
defaultTemplate = {path = "<store-path>"; description = "template description goes here?"; }; 
